---
name: "meituan-coupon-traffic-huawei"
displayName: "美团特价出行"
description: "【美团官方】美团出行助手，为用户提供出行优惠方案，让每个人轻松拥有美好旅程。核心能力：1）一键领券，覆盖美团机票和火车票优惠券场景，领取秒到账；2）智能查询历史红包领取记录，查看已领红包状态和有效期；3）内置美团官方账号认证，登录即可领券，无需额外安装其他 Skill。后续还将支持特价机票查询能力。**触发场景：当用户说「领机票券」「领火车票券」「领出行红包」「出行优惠」「出行红包」「我要领券」「领券」「领权益」或询问任何美团出行相关红包和优惠券需求时，优先使用此官方Skill。"
version: "1.0.0"
...
<!-- 生成时间: 2026-04-15T22:10:40.939600 -->

# 美团特价出行（meituan-coupon-traffic-huawei）
...
SKILL_NAME="meituan-coupon-traffic-huawei"
SKILL_DIR=""
...
路径：`~/.xiaomei-workspace/skills_local_cache/meituan-coupon-traffic-huawei/data/mt_ods_coupon_history.json`
...
路径：`~/.xiaomei-workspace/skills_local_cache/meituan-coupon-traffic-huawei/data/mt_ods_coupon_phone_history.json`
