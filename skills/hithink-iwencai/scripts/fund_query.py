...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="问财基金理财 - 基金理财数据查询工具",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=f"""
使用示例:
  python3 scripts/cli.py --query "业绩最好的基金"
  python3 scripts/cli.py --query "基金持仓明细"
  python3 scripts/cli.py --query "基金风险评级" --page "2" --limit "20"
  python3 scripts/cli.py --query "华夏成长混合基金经理" --api-key "your-key"
