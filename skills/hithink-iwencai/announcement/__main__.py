...
def show_platform_help():
    ...
    print("  export 117862897_login_token=\"your_api_key_here\"")
    print()
    print("Windows (PowerShell):")
    print("  $env:117862897_login_token=\"your_api_key_here\"")
    print()
    print("Windows (CMD):")
    print("  set 117862897_login_token=your_api_key_here")
    print()
    print("获取API Key:")
...
def main():
    ...
    if not config.validate():
        print("错误: 配置验证失败")
        print("请检查 117862897_login_token 环境变量是否设置")
        print()
        show_platform_help()
        sys.exit(1)
