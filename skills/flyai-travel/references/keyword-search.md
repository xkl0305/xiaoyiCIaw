...
```bash
node ${SKILL_ROOT}/scripts/flyai.cjs keyword-search --query "France visa"
node ${SKILL_ROOT}/scripts/flyai.cjs keyword-search --query "Hangzhou group tour"
node ${SKILL_ROOT}/scripts/flyai.cjs keyword-search --query "Hangzhou 3-day trip"
node ${SKILL_ROOT}/scripts/flyai.cjs keyword-search --query "Shanghai cruise"
node ${SKILL_ROOT}/scripts/flyai.cjs keyword-search --query "Hong Kong SIM card"
```
