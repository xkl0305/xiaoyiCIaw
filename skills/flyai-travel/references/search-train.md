...
```bash
node ${SKILL_ROOT}/scripts/flyai.cjs search-train --origin "北京" --destination "上海"
node ${SKILL_ROOT}/scripts/flyai.cjs search-train --origin "北京" --destination "上海" --dep-date 2026-03-15
node ${SKILL_ROOT}/scripts/flyai.cjs search-train --origin "上海" --destination "杭州" --dep-date 2026-03-20 --journey-type 1 --seat-class-name "second class"
node ${SKILL_ROOT}/scripts/flyai.cjs search-train --origin "北京" --destination "上海" --dep-date 2026-03-15 --max-price 800 --sort-type 3
```
