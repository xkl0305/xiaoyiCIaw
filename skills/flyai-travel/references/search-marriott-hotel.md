...
```bash
node ${SKILL_ROOT}/scripts/flyai.cjs search-marriott-hotel --dest-name "上海" --hotel-brands "万豪酒店,喜来登" --check-in-date 2026-03-20 --check-out-date 2026-03-22
node ${SKILL_ROOT}/scripts/flyai.cjs search-marriott-hotel --dest-name "杭州" --hotel-name "杭州JW万豪酒店" --sort price_asc --max-price 1200
```
