...
```bash
node ${SKILL_ROOT}/scripts/flyai.cjs search-hotels --dest-name "杭州" --poi-name "西湖" --check-in-date 2026-03-10 --check-out-date 2026-03-12
node ${SKILL_ROOT}/scripts/flyai.cjs search-hotels --dest-name "三亚" --hotel-stars "4,5" --sort rate_desc --max-price 800
```
