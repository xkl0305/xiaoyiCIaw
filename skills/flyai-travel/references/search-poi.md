...
```bash
node ${SKILL_ROOT}/scripts/flyai.cjs search-poi --city-name "杭州" --keyword "西湖" --category "山湖田园"
node ${SKILL_ROOT}/scripts/flyai.cjs search-poi --city-name "北京" --poi-level 5
node ${SKILL_ROOT}/scripts/flyai.cjs search-poi --city-name "西安" --category "历史古迹"
```
