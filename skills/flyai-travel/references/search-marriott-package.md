...
```bash
node ${SKILL_ROOT}/scripts/flyai.cjs search-marriott-package --keyword "上海"
node ${SKILL_ROOT}/scripts/flyai.cjs search-marriott-package --keyword "JW万豪" --sort-type price_asc
```
