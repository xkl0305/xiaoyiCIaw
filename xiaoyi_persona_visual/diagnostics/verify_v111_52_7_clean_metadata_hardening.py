...
def main() -> int:
    ...
    def _compatible(v: str) -> bool:
        return v == VERSION or str(v).startswith('V111.52.8') or str(v).startswith('V111.52.9') or str(v).startswith('V111.52.10') or str(v).startswith('V111.52.11')
    ...
    overlay_dirs = [p for p in list(ROOT.glob('overlay_payload*')) + list(ROOT.glob('_overlay*')) if p.exists()]
