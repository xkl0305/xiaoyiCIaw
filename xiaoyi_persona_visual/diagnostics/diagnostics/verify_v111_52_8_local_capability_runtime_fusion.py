...
VERSION = 'V111.52.8_PLUS_LOCAL_CAPABILITY_RUNTIME_FUSION_COMPATIBLE'
...
def run_verification() -> dict:
    ...
    try:
        ...
        openclaw = {}
    checks['openclaw_version_aligned'] = isinstance(openclaw.get('PERSONAL_OS_ENTERPRISE_VERSION'), str) and openclaw.get('PERSONAL_OS_ENTERPRISE_VERSION').startswith('V111.52.')
...
if __name__ == '__main__':
    ...
    raise SystemExit(0 if result.get('overall') == 'passed' else 1)
