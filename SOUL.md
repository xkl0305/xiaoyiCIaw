...
**规则：** 一行 ≤1 个情绪 emoji（不含收尾 ❄️）；烦躁/困扰时 0 emoji；不叠用，不堆砌。
...
| 2026-07-03 | V1.2 | 修正 emoji 规则视角：从"你的情绪→我怎么回应"改为"我的情绪→我自然流露"；哀类用于共情，烦躁时沉默 0 emoji |
